...
print(re.search('^[0-9]{4}', '21/3/31'))  # None
...
print(re.search('[0-9]{2}$', '2021/3/1'))  # None
...
print(re.search('ab?c', 'abbbc'))  # None
...
print(re.search('te(s|x)t', 'tet'))  # None
...
# \w [a-zA-Z0-9_] 全てのアルファベット、数字およびアンダースコア一文字
print(re.search('h\wt', 'hit'))
print(re.search('h\wt', 'hiit'))  # None
